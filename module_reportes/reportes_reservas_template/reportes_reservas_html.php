                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseReportes" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
								<nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="../reportes_productos_template/reportes_productos_html.php">Reporte de stock</a>
                                    <a class="nav-link" href="../reportes_reservas_template/reportes_reservas_html.php">Reporte de Reserva</a>
                                    <a class="nav-link" href="../reportes_reclamos_template/reportes_reclamos_html.php">Reporte de Comentarios</a>
                                    <a class="nav-link" href="layout-sidenav-light.html"></a>
                                </nav>
                            </div> 
                        </div>
                                  ...
                                  <tbody>
                                    <?php foreach($data["Detalles"] as $reporte_reserva):?>
										<tr>
											...
											<td><?= $reporte_reserva["sucu_num_mesa"] ?></td>
										</tr>
                                    <?php endforeach ?>
                                </tbody>
                              </table>
